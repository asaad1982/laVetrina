...
<%@ page session="false" %>
    ...
    <link href="<c:url value="/resources/css/showLoading.css" />" rel="stylesheet">
     <!-- specific css -->
    <link href="<c:url value="/resources/templates/levetrina/css/bootstrap.min.css" />" rel="stylesheet">
     
    <!-- template css file -->
    
    <link href="<c:url value="/resources/templates/levetrina/css/font-awesome.min.css" />" rel="stylesheet">
    <link href="<c:url value="/resources/templates/levetrina/css/prettyPhoto.css" />" rel="stylesheet">
    
    <link href="<c:url value="/resources/templates/levetrina/css/price-range.css" />" rel="stylesheet">
    <link href="<c:url value="/resources/templates/levetrina/css/animate.css" />" rel="stylesheet">
   <link href="<c:url value="/resources/templates/levetrina/css/main.css" />" rel="stylesheet">
  <link href="<c:url value="/resources/templates/levetrina/css/responsive.css" />" rel="stylesheet">
