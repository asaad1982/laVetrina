					...
					<jsp:include page="/pages/admin/promotion/promotion-menu.jsp" />
  					<div class="tab-pane active" id="shipping-config">
							...
							<!-- Listing grid include -->
				 			<c:set value="/admin/promotion-categories/paging.html?id=${promotionId}" var="pagingUrl" scope="request"/>
				 			<c:set value="/admin/promotion/categories/update.html?id=${promotionId}" var="updateUrl" scope="request"/>
				 			<c:set value="/admin/promotion/displayPromotionToCategories.html?id=${promotionId}" var="refreshUrl" scope="request"/>
