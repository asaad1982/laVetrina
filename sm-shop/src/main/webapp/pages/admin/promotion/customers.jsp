...
<div class="tabbable">
					...
					<jsp:include page="/pages/admin/promotion/promotion-menu.jsp" />
  					<div class="tab-pane active" id="shipping-config">
								...
								<c:url var="customersPromotionSave" value="/admin/promotion/saveCountries.html"/>
							...
							<!-- Listing grid include -->
				 			<c:set value="/admin/promotion/customers/paging.html?id=${promotionId}" var="pagingUrl" scope="request"/>
				 			<c:set value="/admin/promotion/customers/update.html?id=${promotionId}" var="updateUrl" scope="request"/>
				 			<c:set value="/admin/promotion/customers.html?id=${promotionId}" var="refreshUrl" scope="request"/>
							...
							<c:set var="canRemoveEntry" value="false" scope="request"/>
				 			...
				 			<!-- End listing grid include -->
      								...
      								<form:form method="GET"  action="${customersPromotionSave}">
