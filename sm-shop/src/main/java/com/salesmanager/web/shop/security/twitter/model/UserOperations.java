...
public interface UserOperations {
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials.
	 */
	TwitterProfileWithEmail getUserProfile();
	 ...
	 */
	TwitterProfileWithEmail getUserProfile(String screenName);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials or an application access token.
	 */
	TwitterProfileWithEmail getUserProfile(long userId);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials or an application access token.
	 */
	List<TwitterProfileWithEmail> getUsers(long... userIds);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials or an application access token.
	 */
	List<TwitterProfileWithEmail> getUsers(String... screenNames);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials.
	 */
	List<TwitterProfileWithEmail> searchForUsers(String query);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials.
	 */
	List<TwitterProfileWithEmail> searchForUsers(String query, int page, int pageSize);
	 ...
	 * @throws MissingAuthorizationException if TwitterTemplate was not created with OAuth credentials or an application access token.
	 */
	List<TwitterProfileWithEmail> getSuggestions(String slug);
