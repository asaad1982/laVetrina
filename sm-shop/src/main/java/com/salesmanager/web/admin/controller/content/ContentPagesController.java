...
//	@RequestMapping(value="/admin/content/pages/list.html", method=RequestMethod.GET)
	...
	@PreAuthorize("hasRole('CONTENT')")
	@RequestMapping(value="/admin/content/remove.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	 ...
	 */
	@PreAuthorize("hasRole('CONTENT')")
	@RequestMapping(value="/admin/content/checkContentCode.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
