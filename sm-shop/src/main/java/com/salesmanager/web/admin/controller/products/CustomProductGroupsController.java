...
public class CustomProductGroupsController {
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/products/groups/paging.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/products/groups/update.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/products/group/details/addItem.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/admin/products/group/details/removeItem.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
