...
public class CustomerOptionsValueController {
	...
	@PreAuthorize("hasRole('CUSTOMER')")
	@RequestMapping(value="/admin/customers/options/values/paging.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
	...
	@PreAuthorize("hasRole('CUSTOMER')")
	@RequestMapping(value="/admin/customers/options/values/remove.html", method=RequestMethod.POST, produces={"application/json; charset=UTF-8"})
