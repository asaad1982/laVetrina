...
public class QPromotion extends EntityPathBase<Promotion> {
    ...
    public final DatePath<java.util.Date> endate = createDate("endate", java.util.Date.class);
    ...
    public QPromotion(Class<? extends Promotion> type, PathMetadata<?> metadata, PathInits inits) {
        ...
        this.promotionRule = inits.isInitialized("promotionRule") ? new QPromotionRule(forProperty("promotionRule"), inits.get("promotionRule")) : null;
